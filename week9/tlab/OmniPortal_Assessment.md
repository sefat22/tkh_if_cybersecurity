...
* **Secret Cookie Captured:** _ga=GA1.1.363369834.1776523102; _ga_699NE13B0K=GS2.1.s1776523101$o1$g1$t1776524413$j60$l0$h0; session_id=>
...
* **Fix for API BOLA:** Run an authorization check on every single request to make sure the user actually owns or has rights to that sp>
